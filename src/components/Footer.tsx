                    ...
                    <div className="lg:col-span-2">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-blue-200 text-sm">UNU Yogyakarta</p>
                            </div>
                        </div>
                        ...
                        <ul className="space-y-2">
                            {quickLinks.map((link) => (
                                <li key={link.href}>
                                    <Link
                                        href={link.href}
                                        className="text-blue-100 hover:text-yellow-400 transition-colors text-sm"
                                    >
                                        {link.label}
                                    </Link>
                                </li>
                        ...
                        <div className="flex gap-3">
                            {socialLinks.map((social) => (
                                <a
                                    ...
                                    className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center text-white hover:bg-yellow-500 hover:text-slate-900 transition-all"
